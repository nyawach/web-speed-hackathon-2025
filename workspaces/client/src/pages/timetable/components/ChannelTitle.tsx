...
export const ChannelTitle = ({ channelId }: Props) => {
  ...
  return (
    <div className="relative">
      <div className={`border-x-solid h-[72px] w-auto border-x-[1px] border-x-[#212121] p-[14px] grid place-content-center`} style={{ width }}>
        <img alt={channel.name} className="object-contains" draggable={false} src={channel.logoUrl} />
      </div>
